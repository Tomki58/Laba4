...
void Deque::operator <<(Launch* obj)
{
    {
        node *cur = new node;
        cur->ll = obj;
...
void Deque::operator ()(int id, char *descr, char *userName)
{
    Log *l1 = new Log;
    (*l1)(id, descr, userName);
    *top->ll = *l1;
    top->next = NULL;
    last = top;
}

bool Deque::operator --(int idx)
{
    if (top == NULL)
    {
        return 0;
...
bool Deque::operator >(Deque *obj)
{
    return (this->getCount() > obj->getCount()) ? 1 : 0;
}
